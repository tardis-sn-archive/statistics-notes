...
\begin{align}
  ...
  \left( \firstDeriv{\alpha_i}, \firstDeriv{\beta_i} \right) \log P(\bmx \cond \npack, \bmnu, \bmphi) &=
  \left(
    \left[ \log \beta - \Psi(\alpha) + \log x \right] \nu^i,
    \left[ \frac{\alpha}{\beta} - x \right]\nu^i
  \right)
\end{align}

\begin{align}
  \label{eq:grad-prediction}
  \left( \firstDeriv{\alpha_i}, \firstDeriv{\beta_i}, \firstDeriv{N} \right) \log P(\bmx \cond \npack, \bmnu, \bmphi) &=
  \left(
